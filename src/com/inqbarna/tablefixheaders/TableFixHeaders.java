...
public class TableFixHeaders extends ViewGroup {
	...
	private TableFixHeaders mSecondaryTable;
	...
	public void scrollBy(int x, int y) {
		...
		if (mSecondaryTable != null) {
			mSecondaryTable.scrollBy(x, y);
		}

	}

	public void setSecondaryTable (TableFixHeaders table) {
		mSecondaryTable = table;
	}
